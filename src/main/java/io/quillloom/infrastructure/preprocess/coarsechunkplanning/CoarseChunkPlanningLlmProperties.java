...
@ConfigurationProperties(prefix = "quillloom.preprocess.coarse-chunk-planning.llm")
public class CoarseChunkPlanningLlmProperties {
    ...
    private int timeoutStepSeconds = 90;
    private int maxTimeoutSeconds = 1200;
